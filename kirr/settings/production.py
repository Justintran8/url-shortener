...
SECRET_KEY = 'm-y%rh7m=bio3^j(&x6-z7vzw^v+6+n5f8u7s8df4#7$@c!g_b'
...
INSTALLED_APPS = [
    ...
    'shortener', 'django_hosts', 'analytics',
]
...
DEFAULT_HOST = 'www'
DEFAULT_REDIRECT_URL = 'http://www.flameo.co'
PARENT_HOST = 'flameo.co'
